...
| AIRFLOW_JWT_SECRET | Any Promotion step that uses Airflow 3 | none | Must match the secret that the Airflow 3 deployment signs with. Can be found in Secrets Manager |
